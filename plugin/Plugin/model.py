...
class Plugin(nn.Module):
    def __init__(self, args, channel,timeenc=3):
        ...
        self.timeenc_feature_dims = {0: 6, 1: 6, 2: 7, 3:6}
        encoder_in_features = self.timeenc_feature_dims.get(self.timeenc, 6)
        self.Encoder = nn.Sequential(
            nn.Linear(encoder_in_features, args.dim),
