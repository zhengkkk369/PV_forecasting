...
def parse_args():
    ...
    parser.add_argument('--flag', type=str, default="Standard", help='use GLAFF plugin when set to "Plugin"')
    ...
    parser.add_argument('--dim', type=int, default=256, help='hidden dimension for GLAFF plugin encoder')
    parser.add_argument('--head_num', type=int, default=8, help='attention heads for GLAFF plugin encoder')
    parser.add_argument('--dff', type=int, default=512, help='feedforward dimension for GLAFF plugin encoder')
    parser.add_argument('--layer_num', type=int, default=2, help='encoder layers for GLAFF plugin encoder')
    parser.add_argument('--q', type=float, default=0.75, help='quantile factor for robust scaling in GLAFF plugin')
